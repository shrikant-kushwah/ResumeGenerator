      ...
      >
        <div ref={printElem}>
          ...
          >
            ...
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "+919929897437"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
                ...
                {educationList.map((education) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text fontSize={"sm"}>
                        {school ? school : "College of Engineering gwalior"}
                      </Text>
                      <HStack
                        fontSize={"xs"}
                        fontStyle={"italic"}
                      ...
                      >
                        <Text>
                          {startYr ? startYr : 2019} - {endYr ? endYr : 2023}
                        </Text>
                        <Text>{grade ? grade : "7.6 CGPA"}</Text>
                      </HStack>
                    </VStack>
                  );
                })}
